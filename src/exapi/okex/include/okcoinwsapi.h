/*
 * OKCoinWebSocketApi C++
 * 
 * Inspired from https://github.com/OKCoin/websocket/blob/master/C%2B%2B/websocket_okcoin/debug_client/okcoinwebsocketapi.h
 * 
 * Class OKCoinWebSocketApiCn  - websocket functions for real.okcoin.cn
 * Class OKCoinWebSocketApiCom - websocket functions for real.okcoin.com
 * 
 * $Log: $
 */
